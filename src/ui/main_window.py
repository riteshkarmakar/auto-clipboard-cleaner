...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_export.setText(QCoreApplication.translate("MainWindow", u"Export Settings...", None))
        self.action_load.setText(QCoreApplication.translate("MainWindow", u"Load Settings...", None))
        self.action_documentation.setText(QCoreApplication.translate("MainWindow", u"Read Documentation", None))
